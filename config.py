...
JS_ALL = Bundle('js/jquery-2.0.2.min.js', 'js/jquery-ui-1.10.3.js','js/tinymce/tinymce.min.js', 'js/tinymce/jquery.tinymce.min.js', 'js/jquery.imgareaselect.pack.js' , 'js/messenger.js', 'js/modals.js', 'js/photoview.js')
